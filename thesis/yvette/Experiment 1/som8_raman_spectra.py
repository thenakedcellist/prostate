...
som8.frobenius_norm(y_data)
som8.make_som(10000)
som8.make_labels(y_path, label_list, marker_list, colour_list)
som8.plot_som_scatter(figpath, datestr, onlyshow=True)
som8.plot_density_function(figpath, datestr, onlyshow=True)
winmap = som8.som.win_map(som8.nydata, return_indices=True)
labmap = som8.som.labels_map(som8.nydata, som8.t)
...
labs_poi = [som8.t[i] for i in flat_poi]
