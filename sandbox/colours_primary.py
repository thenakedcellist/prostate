...
data = np.genfromtxt(r'H:\MSc\project\practice_datasets\colours_dataset_small\colours_edit_primary.csv', delimiter=',', skip_header=1, usecols=(0, 1, 2))
...
print('Training...')
som.train_random(ndata, 1000, verbose=True)  # number of iterations
...
# load colour labels
target = np.genfromtxt(r'H:\MSc\project\practice_datasets\colours_dataset_small\colours_edit_primary.csv', delimiter=',', skip_header=1, usecols=(3), dtype=str)
...
plt.markers = ['o', 'o', 'o', 'o']  # add markers to data
