"""
This programme aims to extract and collate the data from each individual Banbury data file.


Data are converted so that signal intensity values for samples obtained
from like animals/tissues are presented in contiguous rows.
An error is throwm if the wavenumbers of samples do not match.
"""
