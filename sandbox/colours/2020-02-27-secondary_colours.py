...
# generate dictionary of all patterns mapped to locus
MiniSom.win_map(som, ndata)

# generate dictionary of number of samples from given label mapped to locus
MiniSom.labels_map(som, ndata, t)
